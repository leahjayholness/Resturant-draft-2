...
// and 'logo' image for use in the navigation and footer
    ...
    <>
      ...
      <nav className="mynavbar navbar navbar-expand-lg sticky-top">
        <div className="container-fluid">
          {/* Link to the homepage, displaying the restaurant's logo and name */}
          <Link to="/" className="navbar-brand">
            {/* Displaying the restaurant logo with specific width and height */}
            <img src={logo} alt="Logo" width="50" height="50" className="d-inline-block"/>
            Resturant Name
          </Link>

          {/* Hamburger button for mobile devices to toggle the navigation menu */}
          <button className="navbar-toggler custom-toggler" type="button" data-bs-toggle="collapse" data-bs-target="#navbarNav" aria-controls="navbarNav" aria-expanded="false" aria-label="Toggle navigation">
            <span className="navbar-toggler-icon"></span>
          </button>

          {/* Collapsible navigation menu for larger screens, aligned to the right */}
          <div className="collapse navbar-collapse justify-content-end" id="navbarNav">
            <ul className="navbar-nav">
              {/* Menu item for the homepage */}
              <li className="nav-item">
                <Link to="/" className="nav-link my-nav-link active">Menu</Link>
              </li>
              {/* Menu item for viewing the user's order (checkout) */}
              <li className="nav-item">
                <Link to="/checkout" className="nav-link my-nav-link active">View Order</Link>
              </li>
              {/* Menu item for making a reservation */}
              <li className="nav-item">
                <Link to="/reservation" className="nav-link my-nav-link active">Reservation</Link>
              </li>
              {/* Menu item for signing in */}
              <li className="nav-item">
      ...
      {/* The Outlet component renders the nested routes inside this Layout component */}
      <Outlet />
      ...
      <div className="container">
        <footer className="d-flex flex-wrap justify-content-between align-items-center py-3 my-4 border-top">
            <div className="col-md-4 d-flex align-items-center">
                {/* Link to the homepage for the logo in the footer */}
                ...
                {/* Text showing copyright information */}
